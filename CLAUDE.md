<!-- SW:META template="claude" version="1.0.331" sections="header,lsp,start,autodetect,metarule,rules,workflow,reflect,context,structure,taskformat,secrets,syncing,testing,tdd,api,limits,troubleshooting,lazyloading,principles,linking,mcp,auto,docs" -->

<!-- SW:SECTION:header version="1.0.331" -->
**Framework**: SpecWeave | **Truth**: `spec.md` + `tasks.md`
<!-- SW:END:header -->

<!-- SW:SECTION:lsp version="1.0.331" -->
## LSP (Code Intelligence)

**Native LSP broken in v2.1.0+.** Use: `specweave lsp refs|def|hover src/file.ts SymbolName`
<!-- SW:END:lsp -->

<!-- SW:SECTION:start version="1.0.331" -->
## Getting Started
...
<!-- SW:SECTION:autodetect version="1.0.331" -->
## Auto-Detection
...
<!-- SW:SECTION:metarule version="1.0.331" -->
...
<!-- SW:SECTION:workflow version="1.0.331" -->
## Workflow
...
<!-- SW:SECTION:reflect version="1.0.331" -->
## Skill Memories
...
<!-- SW:SECTION:context version="1.0.331" -->
## Context
...
<!-- SW:SECTION:api version="1.0.331" -->
<!-- API: Enable `apiDocs` in config.json. Commands: /sw:api-docs -->
<!-- SW:END:api -->

<!-- SW:SECTION:limits version="1.0.331" -->
## Limits
...
<!-- SW:SECTION:lazyloading version="1.0.331" -->
## Plugin Auto-Loading
...
<!-- SW:SECTION:linking version="1.0.331" -->
