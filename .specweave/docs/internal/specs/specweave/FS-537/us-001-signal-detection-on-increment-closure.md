...
- [x] **T-022**: Wire signal collection + suggestion engine into LifecycleHookDispatcher.onIncrementDone()
- [x] **T-030**: Full pipeline integration test — signal detection through suggestion
