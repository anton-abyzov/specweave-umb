...
- [x] **T-008**: Add dashboard data endpoints for sync errors and sync gaps
- [x] **T-009**: OverviewPage — Recent Sync Errors panel and sync gap badge
- [x] **T-010**: SyncPage — Expandable error rows
