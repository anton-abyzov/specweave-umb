...
|-----------|--------|----------------|
| [0427-umbrella-sync-lifecycle-test](../../../../../increments/0427-umbrella-sync-lifecycle-test/spec.md) | ✅ completed | 2026-03-05 |

## User Stories

- [US-VSK-001: VSkill Sync Routing Verification](./us-vsk-001-vskill-sync-routing-verification.md)
...
- [vskill-platform](../../vskill-platform/FS-427/)
