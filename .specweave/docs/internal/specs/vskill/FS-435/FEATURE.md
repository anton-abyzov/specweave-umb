...
external_tools:
  github:
    type: milestone
    id: 8
    url: "https://github.com/anton-abyzov/vskill/milestone/8"
---
...
- [US-VSK-001: Flat install-sorted search results (P1)](./us-vsk-001-flat-install-sorted-search-results-p1.md)

## Related Projects

This feature spans multiple projects:

- [vskill-platform](../../vskill-platform/FS-435/)
