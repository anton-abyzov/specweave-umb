...
- [x] **T-001**: Add `assertion_result` and `case_complete` SSE emissions to comparison endpoint
- [x] **T-002**: Add `outputs_ready` handler to `handleSSEEvent` in WorkspaceContext
- [x] **T-003**: Integration test -- per-case cards render assertions during Compare All
