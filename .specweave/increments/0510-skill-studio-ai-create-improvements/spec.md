...
Improve AI-assisted skill creation: auto-save drafts to filesystem, AI generation history tracking, folder structure visualization, plugin recommendation, remove AI banner and test cases section, fix preview mode, change button label
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0510-skill-studio-ai-create-improvements"
