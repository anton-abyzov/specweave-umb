---
increment: 0635-plugin-caching-hardening
title: "Fix plugin caching silent failures and validation gaps"
type: bug
priority: P1
status: planned
created: 2026-03-20
...
# Feature: Fix plugin caching silent failures and validation gaps

## Overview

Add post-install cache validation, stale version cleanup, sorted version selection, proper error propagation, settings backup, and marketplace version consistency
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0635-plugin-caching-hardening"
