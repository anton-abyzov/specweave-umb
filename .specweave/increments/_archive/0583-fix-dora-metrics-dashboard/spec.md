---
increment: 0583-fix-dora-metrics-dashboard
title: "Fix broken DORA metrics dashboard"
type: bug
priority: P1
status: planned
created: 2026-03-19
...
# Feature: Fix broken DORA metrics dashboard

## Overview

Move metrics output from .specweave/metrics/ to metrics/ to prevent deletion during umbrella cleanup. Update all badge URLs.
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0583-fix-dora-metrics-dashboard"
