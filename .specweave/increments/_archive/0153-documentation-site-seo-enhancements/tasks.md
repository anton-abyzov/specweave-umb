...
**Implementation**:
1. Add line: `Sitemap: https://verified-skill.com/sitemap.xml`
...
- Then sitemap URL should be https://verified-skill.com/sitemap.xml
- And sitemap.xml should be accessible

**Acceptance Criteria**:
- [x] Sitemap URL referenced in robots.txt
- [x] URL points to https://verified-skill.com/sitemap.xml
...
**Acceptance Criteria**:
- [ ] robots.txt accessible at https://verified-skill.com/robots.txt
...
2. Access Google Search Console for verified-skill.com
3. Submit sitemap URL: https://verified-skill.com/sitemap.xml
