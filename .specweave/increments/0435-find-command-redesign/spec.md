...
# Feature: Redesign vskill find command with install counts

## Overview

Reduce default limit to 15, flat list sorted by installs, repo@skill format, remove marketplace grouping, add vskillInstalls to search API
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0435-find-command-redesign"
