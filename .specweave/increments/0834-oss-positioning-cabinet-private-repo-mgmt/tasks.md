...
**Test**: Vitest SSR test asserts every AC bullet (license badge present, Pro lead-bullet text, Enterprise mailto matches anton.abyzov@gmail.com with subject, meta description text, JSON-LD softwareLicense field, OSS hero strip).
