...
## Open questions
Optional user emphasis pending; default all project types with native execution. Manual acceptance required before closing UI increment, per umbrella AGENTS.md; implementation, install and automated verification proceed first.
