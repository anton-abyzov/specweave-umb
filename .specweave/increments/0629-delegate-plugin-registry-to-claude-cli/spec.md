---
increment: 0629-delegate-plugin-registry-to-claude-cli
title: "Delegate plugin registry mutations to claude CLI"
type: refactor
priority: P1
status: planned
created: 2026-03-19
...
# Feature: Delegate plugin registry mutations to claude CLI

## Overview

Replace direct settings.json and plugin cache filesystem writes with claude plugin uninstall CLI delegation
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0629-delegate-plugin-registry-to-claude-cli"
