---
increment: 0463-skill-builder-ui-redesign
title: "Skill Builder UI Redesign"
type: feature
priority: P1
status: planned
created: 2026-03-09
...
# Feature: Skill Builder UI Redesign

## Overview

Refactor Skill Eval into Skill Builder with progress logs, per-eval history, statistics, and connected edit-test-iterate workflow
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0463-skill-builder-ui-redesign"
