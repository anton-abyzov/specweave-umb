...
Add JIRA remote links, ADO hyperlinks, branch naming with external ticket keys, and integration health checks at setup time
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0521-external-integration-smart-linking"
