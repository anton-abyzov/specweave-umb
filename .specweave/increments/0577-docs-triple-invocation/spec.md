...
**ACs:**
- [ ] AC-US1-01: React component `CommandTabs` created at `src/components/CommandTabs/`
- [ ] AC-US1-02: Uses Docusaurus design tokens (indigo-purple palette from tokens.css)
- [ ] AC-US1-03: Three tabs: "Just say it", "Claude Code", "Other AI Tools"
- [ ] AC-US1-04: "Just say it" tab is default/active
- [ ] AC-US1-05: Dark mode support via `[data-theme='dark']`
- [ ] AC-US1-06: CSS modules pattern matching existing components
...
**ACs:**
- [ ] AC-US2-01: overview/introduction.md updated with triple invocation
- [ ] AC-US2-02: getting-started/index.md uses CommandTabs for all examples
- [ ] AC-US2-03: getting-started/first-increment.md uses CommandTabs
- [ ] AC-US2-04: getting-started/installation.md mentions natural language capability

### US-003: Commands Documentation
As a developer, I want every command page to show all three invocation methods.

**ACs:**
- [ ] AC-US3-01: commands/overview.md fully updated with CommandTabs
- [ ] AC-US3-02: All individual command pages (do, auto, auto-status, cancel-auto, status, pause, resume, abandon, save, jobs) updated
- [ ] AC-US3-03: Command tables include natural language column

### US-004: Guides Documentation
As a developer, I want guides to demonstrate the natural language-first approach.

**ACs:**
- [ ] AC-US4-01: guides/brainstorming.md updated with CommandTabs
- [ ] AC-US4-02: All guides with command examples use CommandTabs
- [ ] AC-US4-03: Correct activation words used for each skill

### US-005: Academy, Workflows & Reference Docs
As a learner, I want academy tutorials to teach natural language invocation first.

**ACs:**
- [ ] AC-US5-01: Academy essentials updated with CommandTabs
- [ ] AC-US5-02: Workflow docs use triple invocation pattern
- [ ] AC-US5-03: Reference/commands.md and reference/skills.md updated
- [ ] AC-US5-04: Skills section index updated

### US-006: Enterprise & Integration Docs
As an enterprise user, I want enterprise docs to show all invocation methods.

**ACs:**
- [ ] AC-US6-01: Enterprise release management docs updated
- [ ] AC-US6-02: Skills fundamentals and installation docs updated
