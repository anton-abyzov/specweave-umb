...
# Feature: Skill-Gen LLM Pivot: Replace Keyword Matching with LLM-Based Pattern Extraction

## Overview

Replace hardcoded keyword matching in SignalCollector with LLM-based pattern extraction, fix confidence scoring, fix DriftDetector false positives, add Zod validation, extract shared utils, and add instant seed mode
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0544-skill-gen-llm-pivot"
