---
increment: 0332-native-plugin-install-docs
...
# Feature: Native Plugin Install Documentation
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0332-native-plugin-install-docs"
