---
increment: 0464-skill-builder-create-flow
title: "Skill Builder - Create Skill Flow"
type: feature
priority: P1
status: planned
created: 2026-03-09
...
# Feature: Skill Builder - Create Skill Flow

## Overview

Add New Skill creation wizard to eval-ui with smart placement detection, guided form, and skill-creator integration
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0464-skill-builder-create-flow"
