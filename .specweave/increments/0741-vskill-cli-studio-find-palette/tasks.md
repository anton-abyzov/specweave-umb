...
**File**: `repositories/anton-abyzov/vskill/src/eval-ui/src/components/FindSkillsPalette/components/MiniTierBadge.tsx`
...
**User Story**: US-001 | **Satisfies ACs**: AC-US1-01, AC-US1-04, AC-US1-05 | **Status**: [ ] pending
...
**User Story**: US-004 | **Satisfies ACs**: AC-US4-04, AC-US4-09 | **Status**: [ ] pending
...
**User Story**: US-004 | **Satisfies ACs**: AC-US4-05, AC-US4-06 | **Status**: [ ] pending
...
**User Story**: US-004 | **Satisfies ACs**: AC-US4-08, AC-US4-09 | **Status**: [ ] pending
...
**User Story**: US-001, US-004 | **Satisfies ACs**: FR-001, FR-002, FR-003 | **Status**: [ ] pending
...
**User Story**: US-001, US-002, US-003, US-004 | **Satisfies ACs**: end-to-end coverage | **Status**: [ ] pending
**File**: `repositories/anton-abyzov/vskill/src/eval-ui/playwright/find-skills.spec.ts`
...
**User Story**: US-001 | **Satisfies ACs**: FR-006 | **Status**: [ ] pending
...
**User Story**: post-implementation | **Status**: [ ] pending
