...
scanner.ts hardcoded VERIFIED bypasses vendor check; per-version badge is meaningless; rename labels to Trusted Publisher / Security-Scanned
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0744-fix-cert-tier-muddle-versions-tab"
