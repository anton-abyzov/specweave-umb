...
**User Story**: US-001 | **Satisfies ACs**: AC-US1-01 | **Status**: [x] completed | **Model**: sonnet
...
**User Story**: US-001 | **Satisfies ACs**: AC-US1-02 | **Status**: [x] completed | **Model**: sonnet
...
**User Story**: US-001 | **Satisfies ACs**: AC-US1-03 | **Status**: [x] completed | **Model**: sonnet
**File**: `src/lib/skill-update/__tests__/resolver.test.ts`
**Test Plan**:
...
**User Story**: US-001 | **Satisfies ACs**: AC-US1-03 | **Status**: [x] completed | **Model**: haiku

### T-007: Failing test — user-locked rows are not overwritten
**User Story**: US-001 | **Satisfies ACs**: AC-US1-04 | **Status**: [x] completed | **Model**: sonnet
**File**: `src/lib/skill-update/__tests__/resolver.test.ts`
**Test Plan**:
...
**User Story**: US-001 | **Satisfies ACs**: AC-US1-05 | **Status**: [x] completed | **Model**: sonnet
...
**User Story**: US-002 | **Satisfies ACs**: AC-US2-02, AC-US2-04 | **Status**: [x] completed | **Model**: sonnet
...
**User Story**: US-002 | **Satisfies ACs**: AC-US2-01 | **Status**: [x] completed | **Model**: sonnet
...
**User Story**: US-002 | **Satisfies ACs**: AC-US2-04 | **Status**: [x] completed | **Model**: sonnet
**File**: `scripts/__tests__/backfill-source-repo-url.test.ts`
**Test Plan**:
...
**User Story**: US-002 | **Satisfies ACs**: AC-US2-03, AC-US2-05 | **Status**: [x] completed | **Model**: sonnet
**File**: `scripts/__tests__/backfill-source-repo-url.test.ts`
**Test Plan**:
...
**User Story**: US-002 | **Satisfies ACs**: AC-US2-03 | **Status**: [x] completed | **Model**: haiku
**File**: `scripts/__tests__/backfill-source-repo-url.test.ts`
**Test Plan**:
...
**User Story**: US-002 | **Satisfies ACs**: AC-US2-01..05 | **Status**: [x] completed | **Model**: sonnet
...
**User Story**: US-003 | **Satisfies ACs**: AC-US3-01 | **Status**: [x] completed | **Model**: sonnet
...
**User Story**: US-003 | **Satisfies ACs**: AC-US3-01 | **Status**: [x] completed | **Model**: haiku
**File**: `src/app/api/v1/internal/skills/publish/__tests__/route.test.ts`
**Test Plan**:
...
**User Story**: US-003 | **Satisfies ACs**: AC-US3-02 | **Status**: [x] completed | **Model**: haiku
...
**User Story**: US-003 | **Satisfies ACs**: AC-US3-03 | **Status**: [x] completed | **Model**: sonnet
...
**Satisfies SCs**: SC-003 | **Status**: [x] completed | **Model**: haiku
