...
Fix broken external sync pipeline - GitHub issues not created since FS-238 due to missing living docs folders, suppressed errors, and config gap
...
To complete this specification, run:
  Tell Claude: "Complete the spec for increment 0271-fix-external-sync-pipeline"
