...
- [ ] **AC-US4-02**: The extracted function preserves the behavior of `src/eval-server/skill-create-routes.ts:919-1100` (pre-extraction) — asserted by a snapshot test on 3 target combinations (Claude only, Claude+Codex+Cursor, all 8 universal).
